...
export default function About({ pageInfo }: Props) {
	return (
		<motion.div
			...
			className=' min-h-screen lg:h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-full md:ml-10 justify-evenly mx-auto items-center pt-16 pb-28 sm:pb-0'>
