...
export default function WorkExperience({ experiences }: Props) {
  ...
  return (
    <motion.div
      ...
      className='h-screen flex relative overflow-hidden flex-col text-left md:flex-row max-w-full px-10 pt-20 justify-evenly mx-auto items-center'
    >
      <h3 className=' absolute top-20 uppercase tracking-[20px] text-gray-500 text-2xl pt-5'>
        Training
      </h3>
